...
var paradeArriere = interpolationSpriteObi.paradeArriere;
var attaqueHaut = interpolationSpriteObi.attaqueHaut;
// var coupSpecial = interpolationDuSprite.coupSpecial;
var auRepos = interpolationSpriteObi.base;
...
var testCollision = function () {
  ...
  if (
    gaucheJoueur + largeurJoueur < gaucheAngular ||
...
var zoneJeu = document.getElementById("gameArea");

var sortieJeu;
var testSortieJeu = function () {
  ...
  if (gaucheJoueur < gaucheZoneJeu) {
    deplacementSprite.incrementationDePosition("left", 4);
  } else if (gaucheJoueur + largeurJoueur > gaucheZoneJeu + largeurZoneJeu) {
    deplacementSprite.incrementationDePosition("left", -4);
  } else if (hautJoueur < hautZoneJeu) {
    deplacementSprite.incrementationDePosition("top", 4);
  } else if (hautJoueur + hauteurJoueur > hautZoneJeu + hauteurZoneJeu) {
    deplacementSprite.incrementationDePosition("top", -4);
  }
};
